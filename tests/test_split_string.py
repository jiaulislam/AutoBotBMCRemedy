...
def test_impact_list_format_5():
    ...
    _splited_str = split_string(_string)
    assert _splited_str == ["MBBRL06", "MBBRL07", "PBSDR38", "PBSDR39", "KUDLP05", "JHKLG17", "KUMRP16", "MASDR19",
                            "MASDR25", "MHGNG05", "PBSDR20"]
...
def test_impact_list_list_format_9():
    _string = "DHKGN43,DHDHK32, DHKGNC1, DHMJH1H"
    _splited_str = split_string(_string)
    assert _splited_str == ['DHKGN43', 'DHDHK32', 'DHKGNC1', 'DHMJH1H']
