...
class CreateChangeRequest(BasePage):
    ...
    def test_create_change(self):
        ...
        max_change = self.read_data.get_number_change()
        for change in range(2, max_change+2):
        ...
        # ------- READ ALL THE DATA ------------ #
            ...
            print(f"Woring On: {change-1} \t NCR: {change_number}")
            ...
            self.export_data.save_workbook(self.createChangeRequest)
            # ---------------------------- END -------------------------------------------------- #
